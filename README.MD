...
注册试用并下载SecureCRT + SecureFX 9.0 Bundle：https://www.vandyke.com/download/index.html
```
sha1sum scrt-sfx-9.0.2-2496.rhel8-64.x86_64.rpm #确认是d8355e02f8a828d1414da47c9ce21b4cc29c4bd1
yum install scrt-sfx-9.0.2-2496.rhel8-64.x86_64.rpm
...
```
md5sum anyconnect-linux64-4.10.01075-predeploy-k9.tar.gz #确认是ff161c08aba4fc067d41bb3995ced360
tar zxvf anyconnect-linux64-4.10.01075-predeploy-k9.tar.gz
