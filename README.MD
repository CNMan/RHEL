...
sha1sum VMware-Workstation-Full-26H1-25388281.x86_64.bundle #确认是2945b324113c71fff0e3d229894b8579c471cd1a
sh VMware-Workstation-Full-26H1-25388281.x86_64.bundle --console --ignore-errors
```
...
md5sum cisco-secure-client-linux64-5.1.18.314-predeploy-rpm-k9.tgz #确认是d360c5158bfa56a63ca7bb1a5d81bcc6
tar zxvf cisco-secure-client-linux64-5.1.18.314-predeploy-rpm-k9.tgz
yum install cisco-secure-client-vpn-5.1.18.314-1.x86_64.rpm
